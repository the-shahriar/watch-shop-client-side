            ...
            <div className="products grid grid-cols-1 md:grid-cols-3 gap-4">
                {
                    randomProducts.map(product => {
                        ...
                        return (
                            <div key={_id} className="product text-center">
                                <img src={image} alt="productImg" />
                                <h4 className="text-xl">{title}</h4>
                                <h3 className="font-semibold text-md">Brand: {brand}</h3>
                                 {
                                     offerPrice ?
                                 ...
                                 <button className="bg-gray-600 text-white px-5 py-2 text-md mr-4 mt-2">Add To Cart</button>
                                 <button className="bg-blue-600 text-white px-5 py-2 text-md mt-2">View Details</button>
                            </div>
                        )
                    })
                }
